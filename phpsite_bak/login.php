...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	if(!$sqlUser['user'])
	{
		echo "Такого користувача не існує. Будь-ласка, зареєструйтеся <br/>";
	...
	{		
		accountDeleted();
//		echo "Ваш аккаунт удалён. Пожалуйста обратитесь к администратору сайта";
		exit;
	}
	if($sqlUser['password'] != $password)
	{
		echo "Ваш пароль не вірний. Будь-ласка, введіть правильний пароль!!!<br/> <a href='login.php'>Спробувати ще раз</a>";
		exit;
	}
	else
	{
