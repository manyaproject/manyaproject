...
<table width="1002" border="1" align="center" bgcolor="#FFFFFF" class="main_border">
 <tr >
    <td colspan=2><img src="blocks/img/head.gif" width="1002" height="226"></td>
</tr>
<!--  <tr>
  ...
  <? include ("blocks/lefttd.php");  ?>     
      ...
      <tr> 
       <td width="750" valign="top" background= "blocks/img/kontext.gif" class="style1">
		<b>Інформація для бажаних полікуватися в санаторій-профілакторії “Супутник” ВНТУ</b>
</br>
<ol>
<li>Кількість місць для оздоровлення та лікування — 50 на один заїзд. Тривалість заїзду 0 21 календарний день. Студенти розміщуються по 2-3 в кімнатах блочного житу.</li>
...
Ми чекаємо на Вас.
І де Ви ще знайдете такий спектр послуг і море задоволення, ще й майже задарма.
Головний лікар санаторію-профілакторію “Супутник” ВНТУ Велика Наталія Йосипівна, роб.тел. 598-767, моб.тел. 0962115833

		</p> <td width="250" background= "blocks/img/right.gif">   
  ...
  <tr>
    <td height="22" colspan=2 background= "blocks/img/footer.gif">jf;zjf;sjf;sajf</td>
  </tr>
</table>
</body>
</html>
