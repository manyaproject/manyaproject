...
<!--  
  ...
  <? include ("blocks/lefttd.php");  ?>     
      ...
      <tr> 
       ...
       <p>Це вид лікування теплом. Як тепловий агент тут використовується оброблений озокерний-гірський віск, який складається із суміші парафіну, церезину, мінеральних солей та смол. Для лікування застосовується озокерит з якого видалено воду, луги, кислоти з температурою плавлення 52-55 С. 
